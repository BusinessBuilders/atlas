...
Information architecture from the dashboard audit §E, in owner vocabulary, WCAG 2.2 AA, the type scale of the approved boards (five sizes, three weights), 4-px spacing scale, green/amber/red reserved for health.
